...
const PopularCollegeCard = ({ college, isShadow, index }) => {
    ...
    return (
        <>
            ...
            transition={{ duration: 0.7, delay: ( index - 0.5) }}
                className={`
                    ${isShadow ? 'shadow-[2px_0px_10px] shadow-blue-100' : ''} 
                    rounded-md bg-secondary`}>
                <div className="w-full overflow-hidden rounded-t-md h-1/2">
                    <ImageSlider photos={photos} />
                </div>
                <div className=" w-full pl-5 py-2 md:pt-5 h-1/2 text-gray-500 text-base relative group overflow-hidden rounded-b-md">
